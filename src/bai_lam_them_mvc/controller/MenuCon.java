...
import bai_lam_them_mvc.service.OtoService;
import bai_lam_them_mvc.service.XeMayService;
import bai_lam_them_mvc.service.XeTaiService;
...
public class MenuCon {
    public static void hienThi(){
        ...
        do {
            ...
            switch (choose){
                case 1:
                    XeTai[] xeTais = xeTaiService.timKiemAll();
                    XeTaiView.displayXeTai(xeTais);
                    break;
                case 2:
                    Oto[] otos = otoService.timKiemAll();
                    OtoView.displayOto(otos);
                    break;
                case 3:
                    XeMay[] xeMays = xeMayService.timKiemAll();
